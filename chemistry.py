...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for inner_list in symbol_quantity_list:
        ...
        enter_period_table = periodic_table_dict[symbol]
        atomic_mass = enter_period_table[1]
        # Multiply the atomic mass by the quantity.
        atomic_mass_number = atomic_mass * quantity
        # Add the product into the total molar mass.
        total_molar_mass += atomic_mass_number
...
def sum_protons(symbol_quantity_list, periodic_table_dict):
    ...
    for inner_list in symbol_quantity_list:
        ...
        # Get the atomic mass for the symbol from the dictionary.
        enter_period_table = periodic_table_dict[symbol]
        atomic_number = enter_period_table[2]
        # Multiply the atomic mass by the quantity.
...
def main():
    ...
    mass_chemical_sample = float(input('Enter the mass in grams of sample: '))
    ...
    number_of_moles = mass_chemical_sample / total_molar_mass

    # Call the known_molecules_dict funtion
    formula_name = get_formula_name(formula,known_molecules_dict)

    # Call sum_protons funcion
    total_protons = sum_protons(symbol_quantity_list, periodic_table_dict) 

    # Print the molar mass
    print(f'{total_molar_mass:.5f} grams/molar')
    ...
    # Print number of protons the compound
    print(f'Number of protons: {total_protons}')
